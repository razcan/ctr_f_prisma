...
export default function Content() {
    ...
    // Convert HTML to PDF
    // const exportPdf44 = () => {
    //     pdf.create(text, options).toFile('./output.pdf', (err, res) => {
    //         if (err) {
    //             console.error(err);
    //         } else {
    ...
    //     doc.setFontSize(12);
    //     // Add text to the PDF document with different font sizes
    //     doc.text('Font Size 12', 10, 10);
    //     doc.setFontSize(16);
    //     doc.text('Font Size 16', 10, 20);
    //     doc.setFontSize(20);
    //     doc.text('Font Size 20', 10, 30);
    //     doc.html(text);
    ...
    //     // HTML content with different font sizes
    //     const htmlContent = `
    ...
    //     html2canvas(document.querySelector('#pdfContent') as HTMLElement).then(canvas => {
    ...
    //         // Save the PDF
    //         doc.save('exported_content1.pdf');
    //     });
    // };
    ...
    //             doc.addImage(imageData, 'JPEG', 10, 10, 180, 180 * canvas.height / canvas.width);
    //             doc.save('exported_content.pdf');
    //         });
    //     }
    // };
                ...
                <div className="grid">
                    <div className="col-12">
                        <div className="p-fluid formgrid grid ">
                            ...
                            <div className="field col-12  md:col-3">
                                {/* <Button label="Export to PDF" onClick={exportPdf} /> */}
